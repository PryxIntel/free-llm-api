...
The zh-CN terms below were settled in [#669](https://github.com/PryxIntel/free-llm-api/pull/669)
...
| you (second person) | 您 | Not 你. Settled in [#723](https://github.com/PryxIntel/free-llm-api/pull/723) by unifying all 19 mixed keys; the file had been switching register mid-sentence. Dropping the pronoun entirely is still better where the sentence reads naturally without it. |
